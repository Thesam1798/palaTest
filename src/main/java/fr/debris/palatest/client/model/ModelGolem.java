...
public class ModelGolem extends ModelBase {
    ...
    public ModelGolem(float scaleFactor) {
        this(scaleFactor, -7.0F);
    }

    public ModelGolem(float scaleFactor, float rotationPointY) {
        int i = 128;
        int j = 128;
        this.ironGolemHead = (new ModelRenderer(this)).setTextureSize(128, 128);
        this.ironGolemHead.setRotationPoint(0.0F, 0.0F + rotationPointY, -2.0F);
        ...
        this.ironGolemBody.setRotationPoint(0.0F, 0.0F + rotationPointY, 0.0F);
        ...
        this.ironGolemLeftLeg.setRotationPoint(-4.0F, 18.0F + rotationPointY, 0.0F);
        ...
        this.ironGolemRightLeg.setTextureOffset(60, 0).setRotationPoint(5.0F, 18.0F + rotationPointY, 0.0F);
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
        ...
        scale = scale / 2;
        this.ironGolemHead.offsetY = 0.7F;
        this.ironGolemBody.offsetY = 0.7F;
        this.ironGolemLeftLeg.offsetY = 0.7F;
        this.ironGolemRightLeg.offsetY = 0.7F;
        this.ironGolemRightArm.offsetY = 0.7F;
        this.ironGolemLeftArm.offsetY = 0.7F;
